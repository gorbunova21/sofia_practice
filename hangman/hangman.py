...
# Name: Sofia Gorbunova
# Collaborators: with Maksym Perecenchuk
# Time spent: one week
...
def is_word_guessed(secret_word, letters_guessed):
    ...
    set1 = set(secret_word)
    set2 = set(letters_guessed)
    if (set1 & set2) == set1:
        return True
    else:
        return False
...
def show_possible_matches(my_word):
    ...
    if len(new_list) == 0:
        ...
        print('Possible word matches are:',new_list)
...
def hangman_with_hints(secret_word):
    ...
    * If the guess is the symbol *, print out all words in wordlist that
    ...
    while k > 0:
        ...
        # number_of_unique_letters=
        if is_word_guessed(secret_word, letters_guessed) == True:
            final_core = k * len(set(" ".join(list(secret_word)).split(" ")))
            print('----------------------------')
            print('Congratulations, you won! Your total score for this game is:',final_core)
            break
    if is_word_guessed(secret_word, letters_guessed) == False:
        print('----------------------------')
        print('Sorry, you ran out of guesses. The word was', secret_word)
